...
/**
 * This piece of code manages the request made fromt he client side. It connectes to the PostgreSQL database and runs SQL queries to the database.
 */
...
app.get("/viewSalesHistory", (req, res) => {
  sales = [];
  pool.query("SELECT * FROM saleshistory3;").then((query_res) => {
    for (let i = 0; i < query_res.rowCount; i++) {
